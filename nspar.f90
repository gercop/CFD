...
cccccc ********************************************************************
     ...
     &  CFL,D,sigma,gamma,sp_x,sp_y
      ...
      !MS$DEFINE parallel        = 00    !Type of process:
                                         !  0 = Sequential
                                         !  1 = Parallel

      !MS$DEFINE tp_dim          = 02    !Type of dimension:
                                         !  1 = One dimension
                                         !  2 = Two dimensions
                                         !  3 = Three dimensions

      !MS$DEFINE tp_s            = 06    !Type of simulation:
                                         !  1 = Model Equation;
                                         !  2 = Progressive Wave;
                                         !  3 = Standing Wave;
      ...
      !MS$DEFINE filter_in_z     = 00    !Compact filter in the z-direction
      ...
      !MS$DEFINE tp_dat2ASC      = 00    !Convert binary files to ASC pattern;
      ...
      parameter (
     &  qtimes        = 500,                  !Number of steps stored in time
     ...
     &  imax          = 000000200+1,          !Maximum size in the x-direction
     &  jmax          = 000000200+1,          !Maximum size in the y-direction 
     &  kmax          = 000000000+1,          !Maximum size in the z-direction 
     &  tmin          = 00000000000,          !Maximum size in the time
     &  tmax          = 00000100000,          !Maximum size in the time
     ...
     &  Ma       = 0.5d0,                     !Mach Number, dimensionless 
     &  Re       = 1.d+03,                    !Reynolds number, dimensionless
...
ccccc ************************************
     ...
     &  A_1      = 0.00000000d0,              !Wave amplitude (Fluctuation) - m
     &  A_2      = 0.00000000d0,              !Wave amplitude (Fluctuation) - m
     &  A_3      = 0.00000000d0,              !Wave amplitude (Fluctuation) - m
     &  A_4      = 0.00000000d0,              !Wave amplitude (Fluctuation) - m
     &  phi      = 0.0d0,                     !Phase difference - m
     &  x_0      = 5.0d0,                     !Initial domain in the x-direction - m
     &  y_0      = 0.0d0,                     !Initial domain in the y-direction - m
     &  z_0      = 0.0d0,                     !Initial domain in the z-direction - m
     &  Lx       = 020.000000d0-x_0,          !Comp. domain in the x-direction - m
     &  Ly       = 001.000000d0-y_0,          !Comp. domain in the y-direction - m
     &  Lz       = 001.000000d0-z_0,          !Comp. domain in the z-direction - m
     &  Lx_spo   = 100.000000d0,              !Sponge domain extend from Lx to Lx_spo - m
     &  alpha    = 2.d0*Pi/Lx,                !Wavenumber in the x-direction - 1/m
     &  kapa     = 2.d0*Pi/Ly,                !Wavenumber in the y-direction - 1/m
     &  beta     = 0.d0*Pi/Lz,                !Wavenumber in the z-direction - 1/m
     ...
     &  sp_y     = 1.08d0,                     !Stretching parameter in the y-coordinate
