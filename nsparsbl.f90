...
cccccc *******************************************************************
     ...
     &  CFL,D,sigma,gamma,R,cv,cp,Ma,Re,Pr,M1,M2
      ...
      !MS$DEFINE stretching_in_y = 0     !Stretching in y-direction
     ...
     &  imax          = 000000200+1, !Maximum size in x-direction 
     &  jmax          = 000000200+1, !Maximum size in y-direction 
...
ccccc ***********************************
     ...
     &  Ly       = 000.100000d0-y_0,          !Comp. domain in y-direction - m
     &  Lz       = 016.000000d0-z_0,          !Comp. domain in z-direction - m
     &  alpha_1  = 2.d0*Pi/Lx,                !Wavenumber in x-direction - Fundamental - 1/m
     &  alpha_2  = 1.d0*Pi/Lx,                !Wavenumber in x-direction - Subharmonic - 1/m
