...
cccccc ********************************************************************
     ...
     &  CFL,D,sigma,gamma,Ma,Re,Pr,M1,M2
      ...
      !MS$DEFINE tp_s            = 03    !Simulation type:
                                         !  1 = Model Equation;
                                         !  2 = Progressive Wave;
                                         !  3 = Standing Wave;
      ...
      !MS$DEFINE stretching_in_y = 00    !Stretching in y-direction
     ...
     &  imax          = 00000000051, !Maximum size in x-direction 
     &  jmax          = 00000000051, !Maximum size in y-direction 
...
ccccc ***********************************
     ...
     &  A_3      = A_2/10.d0,                 !Wave amplitude (Fluctuation) - m
     &  A_4      = A_3/10.d0,                 !Wave amplitude (Fluctuation) - m
     ...
     &  Lx       = 001.000000d0-x_0,          !Comp. domain in x-direction - m
     &  Ly       = 001.000000d0-y_0,          !Comp. domain in y-direction - m
     &  Lz       = 001.000000d0-z_0,          !Comp. domain in z-direction - m
     &  Lx_spo   = 600.d0,                    !Sponge domain extend from Lx to Lx_spo - m
     &  alpha_1  = 8.d0*Pi/Lx,                !Wavenumber in x-direction - Fundamental - 1/m
     &  alpha_2  = 4.d0*Pi/Lx,                !Wavenumber in x-direction - Subharmonic - 1/m
     &  kapa     = 8.d0*Pi/Ly,                !Wavenumber in y-direction - 1/m
     ...
     &  dt       = 1.0d-03)                   !Step size in the time     
