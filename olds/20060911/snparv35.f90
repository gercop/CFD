...
cccccc *******************************************************************
     ...
     &  CFL,D,sigma,gamma,R,cv,cp,Ma,Re,Pr,M1,M2
      ...
      !MS$DEFINE sv_TEC_BIN      = 1     !Save file in tecplot system - binary
      !MS$DEFINE sv_TEC_ASC      = 0     !Save file in tecplot system - asc
