...
ccccc **********************************************************************
      SUBROUTINE sv_TCP_ALL_PAR_SASC_1D(fname,x)
...
ccccc **********************************************************************
      SUBROUTINE sv_TCP_ALL_PAR_SASC_2D(fname,x,y)
...
ccccc **********************************************************************
      SUBROUTINE sv_TCP_ALL_PAR_SASC_3D(fname,x,y,z)
...
ccccc **********************************************************************
      ...
      if ((jmax.EQ.1).AND.(kmax.EQ.1)) then
        ...
        call sv_TCP_ALL_PAR_SASC_2D(fname_aux,x,y)
      else if ((jmax.NE.1).AND.(kmax.NE.1)) then
        call sv_TCP_ALL_PAR_SASC_3D(fname_aux,x,y,z)
      end if
...
ccccc **********************************************************************
      ...
      USE snmethod,  only: stencil_x_ex_6th_D,global_stx_ex_6th_D
