...
cc     &  -stx(1,7)*fc(7,j,k))
      ...
      !Extrapolation of fifth order
        fc(1,j,k) = 1.d0/274.d0*(600.d0*fc(2,j,k)
     &    -600.d0*fc(3,j,k)+400.d0*fc(4,j,k)
...
ccccc **********************************************************************
      ...
      !Extrapolation of fifth order
cc      fc(local_imax,j,k) = 1.d0/stxx(local_imax,7)*(
cc     &  -stxx(local_imax,1)*fc(local_imax-6,j,k)+
cc     &  -stxx(local_imax,2)*fc(local_imax-5,j,k)+
cc     &  -stxx(local_imax,3)*fc(local_imax-4,j,k)+
cc     &  -stxx(local_imax,4)*fc(local_imax-3,j,k)+
cc     &  -stxx(local_imax,5)*fc(local_imax-2,j,k)+
cc     &  -stxx(local_imax,6)*fc(local_imax-1,j,k))

      !Extrapolation of fourth order
      fc(local_imax,j,k) = 1.d0/225.d0*(770.d0*fc(local_imax-1,j,k)
     &  -1070.d0*fc(local_imax-2,j,k)+780.d0*fc(local_imax-3,j,k)
     &  -305.d0*fc(local_imax-4,j,k)+50.d0*fc(local_imax-5,j,k) )
