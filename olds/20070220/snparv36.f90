...
cccccc Programmer\Guide  : Ricardo A. Coppola Germanos
...
cccccc *******************************************************************
     ...
     &  CFL,D,sigma,gamma,R,cv,cp,Ma,Re,Pr,M1,M2
      ...
      !MS$DEFINE filter_in_z     = 1     !Compact filter in z-direction
     ...
     &  jmax          = 000000080+1, !Maximum size in y-direction 
     &  kmax          = 000000030+1, !Maximum size in z-direction 
...
ccccc ***********************************
     ...
     &  A        = 0.20000000d0,              !Wave amplitude (Fluctuation) - m
     ...
     &  Ly       = 080.000000d0-y_0,          !Comp. domain in y-direction - m
