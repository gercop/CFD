...
cc          write(*,*) 'THERE ARE ',pro,' PROCESSORS.'
cc          write(*,*)
        end if
cc        write(*,*) 'GREETINGS FROM PROCESSOR: ',my_rank
        if (my_rank.EQ.0) read(*,*) 
      !MS$ELSE
cc        write(*,*) 'GREETINGS FROM PROCESSOR: 1'
        my_rank = 0
        pro     = 1
      !MS$ENDIF
...
cc      write (*,*) my_rank,'local_imax :',local_imax
cc      write (*,*) my_rank,'local_bx   :',local_bx 
cc      write (*,*) my_rank,'global_x1  :',global_x1 
cc      write (*,*) my_rank,'global_x2  :',global_x2
cc      write (*,*) my_rank,'local_sd   :',local_sd(1)
cc      write (*,*) my_rank,'local_sd   :',local_sd(2)
