...
ccccc **********************************************************************
      SUBROUTINE init_cond(my_rank,local_imax,x,y,z)

      integer i,j,k,my_rank,local_imax
...
ccccc **********************************************************************
      ...
      if ((jmax.EQ.1).AND.(kmax.EQ.1)) then 
        call read_BIN_1D(fname_aux,E1,E2,E5,error)
      else if ((jmax.NE.1).AND.(kmax.EQ.1)) then
        call read_BIN_2D(fname_aux,E1,E2,E3,E5,error)
      else if ((jmax.NE.1).AND.(kmax.NE.1)) then 
        call read_BIN_3D(fname_aux,E1,E2,E3,E4,E5,error)
      end if
