...
cccccc ********************************************************************
     ...
     &  CFL,D,sigma,gamma,sp_x,sp_y,extra_y
     ...
     &  tmax          = 00000020000, !Maximum size in the time
...
ccccc ************************************
     ...
     &  A_1      = 0.05000000d0,              !Wave amplitude (Fluctuation) - m
     &  A_2      = 0.00000000d0,              !Wave amplitude (Fluctuation) - m
     &  A_3      = 0.02500000d0,              !Wave amplitude (Fluctuation) - m
     ...
     &  Lx       = 015.320000d0-x_0,          !Comp. domain in the x-direction - m
     &  Ly       = 040.000000d0-y_0,          !Comp. domain in the y-direction - m
     &  Lz       = 015.320000d0-z_0,          !Comp. domain in the z-direction - m
