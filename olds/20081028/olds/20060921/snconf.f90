...
ccccc **************************************************************************
     ...
     &  du_0_dy  (local_imax,jmax,kmax),d2u_0_dy2(local_imax,jmax,kmax)
      ...
      if (pro.NE.1) call exchange_ghostpoints(jmax,kmax,
     &  E1,E2,E3,E4,E5)
      call flux_to_primitive(local_imax,E1,E2,E3,E4,E5,
     &  rho,u,v,w,Et,p,tp,mu)
...
ccccc **********************************************************************
     ...
     &  dfc_dx(local_imax,jmax,kmax)
      ...
      !MS$ELSEIF (tp_s.EQ.5).OR.(tp_s.EQ.6)
        call der_x_ex_6th_D(dx,my_rank,pro,local_imax,jmax,kmax,stx,fc,dfc_dx)
      !MS$ENDIF
...
ccccc **********************************************************************
      ...
      !MS$ELSEIF (tp_s.EQ.5).OR.(tp_s.EQ.6)  
        call der_xx_ex_6th_D(dx,local_imax,jmax,kmax,stxx_ex_6th_D,fc,d2fc_dx2)
      !MS$ENDIF
...
ccccc **********************************************************************
     ...
     &  d2fc_dxy(local_imax,jmax,kmax)
      ...
      !MS$ELSEIF (tp_s.EQ.4)
        ...
        call der_y_cp_62th_D(dcy_dpy,dfc_dx,d2fc_dxy)
      !MS$ELSEIF (tp_s.EQ.5)
        call der_x_ex_6th_D(dx,my_rank,pro,local_imax,jmax,kmax,stx_ex_6th_D,fc,dfc_dx)
        !MS$IF (stretching_in_y.EQ.0)     
...
ccccc **********************************************************************
     ...
     &      dcy_dpy,fc,dfc_dy)
        !MS$ENDIF 
        call der_x_ex_6th_D(dx,my_rank,pro,local_imax,jmax,kmax,stx_ex_6th_D,dfc_dy,d2fc_dyx)
      !MS$ELSEIF (tp_s.EQ.6)  
        !MS$IF (stretching_in_y.EQ.0)     
          call der_y_cp_65th_WN(dy,local_imax,jmax,kmax,dcy_dpy,fc,dfc_dy)
        !MS$ELSEIF (stretching_in_y.EQ.1) 
...
ccccc **********************************************************************
     ...
     &  d2fc_dzx(local_imax,jmax,kmax)
      ...
      !MS$ELSEIF (tp_s.EQ.5).OR.(tp_s.EQ.6)
        call der_z_cp_6th_P(dz,local_imax,jmax,kmax,fc,dfc_dz)
        call der_x_ex_6th_D(dx,my_rank,pro,local_imax,jmax,kmax,stx_ex_6th_D,dfc_dz,d2fc_dzx)
      !MS$ENDIF
