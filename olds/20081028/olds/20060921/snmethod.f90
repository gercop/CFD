...
ccccc **********************************************************************
     ...
     &          stx(i,7)*fc(imax,j,k)
            ...
            dfc_dx(imax-1,j,k) = 1.d0/(6.d0*dx)*(2.d0*fc(imax,j,k)
     &        +3.d0*fc(imax-1,j,k)-6.d0*fc(imax-2,j,k)+fc(imax-3,j,k))
            dfc_dx(imax-0,j,k) = 1.d0/(6.d0*dx)*(11.d0*fc(imax,j,k)
     &        -18.d0*fc(imax-1,j,k)+9.d0*fc(imax-2,j,k)-2.d0*fc(imax-3,j,k))
          end if
        end do
      end do
...
ccccc **********************************************************************
     ...
     &          stxx(i,7)*fc(imax-0,j,k)
            ...
            d2fc_dx2(imax-1,j,k) = 1.d0/(3.d0*dx*dx)*(3.d0*fc(imax,j,k)
     &        -6.d0*fc(imax-1,j,k)+3.d0*fc(imax-2,j,k)-0.d0*fc(imax-3,j,k))
            d2fc_dx2(imax-0,j,k) = 1.d0/(3.d0*dx*dx)*(6.d0*fc(imax,j,k)
     &        -15.d0*fc(imax-1,j,k)+12.d0*fc(imax-2,j,k)-3.d0*fc(imax-3,j,k))
          end if
        end do
      end do
