...
ccccc ************************************************************************************************
ccccc group_for_output_axis: This subroutine groups the whole flow field on one processor.
ccccc ************************************************************************************************
      SUBROUTINE group_for_output_axis(imax,jmax,kmax,local_x,global_x)
     ...
     &        MPI_COMM_WORLD,status,ierror)  
      ...
      RETURN 
      END SUBROUTINE group_for_output_axis
