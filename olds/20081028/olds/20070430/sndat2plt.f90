...
ccccc **********************************************************************
     ...
     &          Qi,rho,p,tp,Et)
      ...
      deallocate(dcy_dpy,d2cy_dpy2)
      deallocate(stx_ex_6th_D,stxx_ex_6th_D)
...
ccccc **********************************************************************
     ...
     &  stencil_x_ex_6th_D,stencil_xx_ex_6th_D,dcy_dpy,d2cy_dpy2     

      IMPLICIT NONE
      INCLUDE 'snparv36.f90'

      integer i,j,k,i_aux,my_rank,pro_aux,local_imax,tp_s_aux
      real*8 x(imax),y(jmax),z(kmax),Ma_aux,Re_aux

      allocate(dcy_dpy      (jmax)  )
      allocate(d2cy_dpy2    (jmax)  )
      allocate(stx_ex_6th_D (imax,7))
      allocate(stxx_ex_6th_D(imax,7))
      ...
      call stencil_x_ex_6th_D (0,1,imax,tp_s_aux,x,stx_ex_6th_D )
      call stencil_xx_ex_6th_D(0,1,imax,x,stxx_ex_6th_D)
...
ccccc **********************************************************************
      SUBROUTINE read_BIN_1D_PP(fname,u,rho,p,tp,Et,error)
...
ccccc **********************************************************************
      SUBROUTINE read_BIN_2D_PP(fname,u,v,wz,rho,p,tp,Et,error)
...
ccccc **********************************************************************
      SUBROUTINE read_BIN_3D_PP(fname,x,y,z,u,v,w,wx,wy,wz,Qi,rho,p,tp,Et,error)
