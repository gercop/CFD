...
cccccc ********************************************************************
     ...
     &  qtimes,imax_phy,imax,jmax,kmax,tmin,tmax
      ...
      real*8
     &  Pi,c,A,alpha,kapa,beta,ffreq,omega,x_0,y_0,z_0,
     ...
     &  CFL,D,sigma,gamma,Ma,Re,Pr,M1,M2
      ...
      !MS$DEFINE stretching_in_x = 01	 !Stretching in x-direction
     ...
     &  imax          = 00000000301, !Maximum size in x-direction 
     &  jmax          = 00000000101, !Maximum size in y-direction 
     ...
     &  Ma       = 0.2d0,                     !Mach Number, dimensionless 
...
ccccc ***********************************
     ...
     &  M2       = Ma-0.1d0,                  !Mach number for y<0, dimensionless 
     ...
     &  Lx       = 200.000000d0-x_0,          !Comp. domain in x-direction - m
     &  Ly       = 100.000000d0-y_0,          !Comp. domain in y-direction - m
     &  Lz       = 050.000000d0-z_0,          !Comp. domain in z-direction - m
     &  Lx_spo   = 600.d0,                    !Sponge domain extend to Lx_spo - m
     ...
     &  dt       = 5.0d-03)                   !Step size in the time     
