...
cccccc ********************************************************************
     ...
     &  qtimes_x,qtimes_y,qtimes_z,extra_x,extra_y,extra_z
      ...
      real*8
     &  Pi,Ma,Re,Pr,M1,M2,c,A_1,A_2,A_3,A_4,alpha,kapa,beta,ffreq,omega,phi,
     ...
     &  CFL,D,sigma,gamma,sp_x,sp_y
      ...
      !MS$DEFINE tp_s            = 04    !Type of simulation:
                                         !  1 = Model Equation;
                                         !  2 = Progressive Wave;
                                         !  3 = Standing Wave;
      ...
      !MS$DEFINE tp_proc         = 02    !Type of process:
                                         !  1 = Full energy equation flow; 
                                         !  2 = Isentropic flow (Adiabatic);

      !MS$DEFINE tp_viscous      = 02    !Law for viscosity:
                                         !  1 = Suntherland law; 
      ...
      !MS$DEFINE tp_dat2fft      = 01    !  Carry out Fourier Spectral Analysis;
      ...
      parameter (
     &  qtimes        = 200, !Quantidade de pontos armazenados no tempo
     &  qtimes_x      = 01,  !Quantidade de pontos armazenados na direção x
     &  qtimes_y      = 01,  !Quantidade de pontos armazenados na direção y
     &  qtimes_z      = 01,  !Quantidade de pontos armazenados na direção z

     &  extra_x       = 01,  !Agrupar simulações na direção x
     &  extra_y       = 01,  !Agrupar simulações na direção y
     &  extra_z       = 01,  !Agrupar simulações na direção z

     &  imax          = 00000000041, !Maximum size in the x-direction 
     &  jmax          = 00000000101, !Maximum size in the y-direction 
     &  kmax          = 00000000041, !Maximum size in the z-direction 
     &  tmin          = 00000000000, !Maximum size in the time
     &  tmax          = 00000030000, !Maximum size in the time
...
ccccc ************************************
     ...
     &  phi      = 1.d0/2.d0*pi,              !Gaussian curvature
     ...
     &  Lx       = 007.650000d0-x_0,          !Comp. domain in the x-direction - m
     &  Ly       = 040.000000d0-y_0,          !Comp. domain in the y-direction - m
     &  Lz       = 030.600000d0-z_0,          !Comp. domain in the z-direction - m
     ...
     &  sp_x     = 03.d0,                     !Stretching parameter in the x-coordinate
                                              !  For slayer - sp_x = 3.00d0
                                              !  For blayer - sp_x = 3.00d0
     &  sp_y     = 06.d0,                     !Stretching parameter in the y-coordinate
                                              !  For slayer - sp_x = 6.00d0
                                              !  For blayer - sp_x = 1.08d0
