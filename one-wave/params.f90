...
!----- Constants -------------------------------------------------------------------------------------------------------!
! IC and BC
   real, parameter, public :: c=1.0d0, w=1.0d0

! grid
   integer, parameter, public :: nx=41
   real, parameter, public :: x_0=-1.0d0, x_L=1.0d0
   real, parameter, public :: alpha = 0.91d0 ! 0.91

! time
   integer, parameter, public :: t_be=1, t_en=5020
   real, parameter, public :: dt=1d-2
